...
filename1 <- 'data/seed1/grid_nn_lee2018'
...
filename2 <- 'data/seed1/grid_nn_custom'
...
filename1 <- 'data/seed1/grid_nn_trans_lee2018'
model <- read_csv(paste0(filename1, '.csv'))
loss <- read_csv(paste0(filename1, '_val_loss.csv')) %>%
  mutate(loss = sqrt(val_loss)) %>%
  inner_join(model, by = 'model_num')
...
filename2 <- 'data/seed1/grid_nn_trans_custom'
model <- read_csv(paste0(filename2, '.csv'))
loss <- read_csv(paste0(filename2, '_val_loss.csv')) %>%
  mutate(loss = sqrt(val_loss)) %>%
  inner_join(model, by = 'model_num')
...
filename1 <- 'data/seed1/grid_basis_4by4_lee2018'
model <- read_csv(paste0(filename1, '.csv'))
loss <- read_csv(paste0(filename1, '_val_loss.csv')) %>%
  mutate(loss = sqrt(val_loss)) %>%
  inner_join(model, by = 'model_num')
...
filename2 <- 'data/seed1/grid_basis_4by4_custom'
model <- read_csv(paste0(filename2, '.csv'))
loss <- read_csv(paste0(filename2, '_val_loss.csv')) %>%
  mutate(loss = sqrt(val_loss)) %>%
  inner_join(model, by = 'model_num')
...
filename1 <- 'data/seed1/grid_basis_4by4_20by20_lee2018'
model <- read_csv(paste0(filename1, '.csv'))
loss <- read_csv(paste0(filename1, '_val_loss.csv')) %>%
  mutate(loss = sqrt(val_loss)) %>%
  inner_join(model, by = 'model_num')
...
filename2 <- 'data/seed1/grid_basis_4by4_20by20_custom'
model <- read_csv(paste0(filename2, '.csv'))
loss <- read_csv(paste0(filename2, '_val_loss.csv')) %>%
  mutate(loss = sqrt(val_loss)) %>%
  inner_join(model, by = 'model_num')
